...
2. Asks how many sticks
3. Differentiate players

game loop
1. Display number of sticks
2. ask current player how many sticks to take
3. Subtract sticks
4. determine if game is over
5. Switch players
6. REPEAT
